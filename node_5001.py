...
class BlockChain:
    ...
    def add_transaction(self,name,aadhar,pan,address,phone):
...
def add_transaction():
    ...
    receiver_data = request.get_json()
    print(receiver_data)
    transaction_keys = ['name','aadhar','pan','address','phone']
    print(json)
    if not all(key in json for key in transaction_keys):
        return 'Some elements of the transaction are missing', 400
    index = blockchain.add_transaction(json['name'], json['aadhar'], json['pan'],json['address'],json['phone'])
